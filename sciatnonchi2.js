define(['pipAPI', 'https://cdn.jsdelivr.net/gh/baranan/minno-tasks@0.*/stiat/qualtrics/qstiat6.js'], function(APIConstructor, stiatExtension){
	...
	var API = new APIConstructor();
		  ...
		  category : { 
		    name : 'Non-Chinese', //Will appear in the data.
		    title : {
		      media : {word : 'Non-Chinese'}, //Name of the category presented in the task.
		      css : {color:'#00B317','font-size':'2em'}, //Style of the category title.
		    ...
		    //Stimulus css (style)
		    css : {color:'#00B317','font-size':'3em'}
		  },	
		...
		instTemplateCategoryRight : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'and for items that belong to the category <font color="#00B317">thecategory</font>.<br/>' + 
				'Items will appear one at a time.<br/><br/>' + 
				'If you make a mistake, a red <font color="#ff0000"><b>X</b></font> will appear. ' + 
				'Press the other key to continue.<br/><br/>' + 
				'<p align="center">Press the <b>space bar</b> when you are ready to start.</font></p></div>', 
